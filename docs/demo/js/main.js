	    ...
	    _createClass(DistributionBuilder, [{
	        ...
	        value: function labelize(o) {
	            ...
	            if (obj.hasOwnProperty('labels')) {
	                ...
	                var step = (this.max - this.min) / this.nBuckets;
	                values = Array.from({ length: this.nBuckets }, function (value, key) {
...
/***/ (function(module, exports) {
	...
	function MouseHold($) {
	    $.fn.mousehold = function (timestart, timeout, f) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _distributionbuilder = __webpack_require__(43);
